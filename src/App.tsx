...
import AgoraMarkets from "./pages/AgoraMarkets";
...
import LineraDemo from "./pages/LineraDemo";
        ...
        <Layout>
          <Suspense fallback={<PageLoader />}>
            <Routes>
              ...
              <Route path="/agora" element={<AgoraMarkets />} />
              ...
              <Route path="/demo/linera" element={<LineraDemo />} />
