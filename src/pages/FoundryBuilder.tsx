...
export default function FoundryBuilder() {
  ...
  const [marketDuration, setMarketDuration] = useState("7");
  ...
  const handleDeploy = async () => {
    ...
    try {
      ...
      // Reset form and navigate to marketplace
      setMarketName("");
      ...
      console.error('[Foundry] Error creating market:', error);
      toast({
        title: "Deployment Failed",
        description: error instanceof Error ? error.message : "Failed to create market on Linera",
        variant: "destructive",
      });
    } finally {
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-xs text-text-muted mt-1">
                    Published to Linera registry chain
                  </p>
                </div>
                ...
                <div className="grid md:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    <Input 
                      ...
                      className="bg-surface"
                      value={(() => {
                        const days = parseInt(marketDuration) || 7;
                        const date = new Date();
